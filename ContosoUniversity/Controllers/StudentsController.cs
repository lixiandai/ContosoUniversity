...
namespace ContosoUniversity.Controllers
{
    public class StudentsController : Controller
    {
        ...
        public async Task<IActionResult> IndexWithSortOrderAndSearch(string sortOrder, string searchString)
        {
            ViewData["NameSortParm"] = string.IsNullOrWhiteSpace(sortOrder) ? "name_desc" : "";
            ViewData["DateSortParm"] = sortOrder == "Date" ? "date_desc" : "Date";
            ViewData["CurrentFilter"] = searchString;
        ...
        // GET: Students
        public async Task<IActionResult> IndexSimple()
        {
            return View(await _context.Students.AsNoTracking().OrderBy(s => s.LastName).ToListAsync());
        }

        public async Task<IActionResult> IndexWithSortOrder(string sortOrder)
        {
            ViewData["NameSortParm"] = string.IsNullOrWhiteSpace(sortOrder) ? "name_desc" : "";
            ViewData["DateSortParm"] = sortOrder == "Date" ? "date_desc" : "Date";
            IQueryable<Student> students = _context.Students.Select(s => s);
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            // Get specific student, their enrollments and their courses
